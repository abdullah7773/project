...
const char* username1 = "Abdullah";
const char* username2 = "Shan";
const char* username3 = "Muneer";
...
void Passenger::bookFlight(){
	...
	//cout<<ctime(&t);
	fout<<"Boarding Pass\n---------------------""\n\nWONDER AIRLINES" << "\t\tName: "<<getName()<<"\t\tDestination: "
	<<getTo()<<" to "<<getFrom()<<"\n\nOption: "<<getClassType()
	<<"\nSeat: "<<getSeatType()<<" "<<getSeatNo()<<"\nDeparture :\t"<<waqt.tm_hour<<":"<<waqt.tm_min<<"PM"
	<<"("<<day2<<")"<<day<<"of May"<<endl;
	clear_Area(45,13,115,11);
...
void Membership::registerYourself(){
	...
	fout<<"Member Ship Card \n-------------------------"<<"\n\n|WONDER AIR|"<<"\n\nWONDER AIRLINES" <<"\nMEMBER"<< "\t\tUsername : "
	<<s<<"\nDate of Birth : "<<d_o_b<<"\tNationality : "<<na<<"\n\n---------------------------------------";
	clear_Area(45,13,115,11);
	gotoxy (45,15); cout << "Your Membership Card is being generated.";
	gotoxy (45,16); cout << "Print your Card and you will be taken back to main screen.";
	gotoxy (45,17); cout << "THANK YOU FOR CHOOSING WONDER AIR ! see you on the other side.";
	Sleep (7000);
	HWND hwnd = ::CreateWindowA("STATIC","dummy",WS_VISIBLE,0,0,50,50,NULL,NULL,NULL,NULL);
	::SetWindowTextA(hwnd,"Ignore This Window!");
...
void Membership::book(string s){
	...
	clear_Area(45,13,115,10);
	fout<<"Boarding Pass\n---------------------"<<"|WONDER AIR|"<<"\n\nWONDER AIRLINES" <<"\nMEMBER"<< "\t\tUSername: "<<getName()<<"\t\tDestination: "
	<<getTo()<<" to "<<getFrom()<<"\n\nOption: "<<getClassType()
	<<"\nSeat: "<<getSeatType()<<" "<<getSeatNo()<<endl<<"";
	clear_Area(45,13,115,11);
	gotoxy (45,15); cout << "Your Boarding Pass is being generated.";
	gotoxy (45,16); cout << "Print your pass and you will be taken back to main screen.";
	gotoxy (45,17); cout << "THANK YOU FOR FLYING WONDER AIR ! see you on the other side.";
